            ...
            <form method="POST" action="{{ route('posts.store') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tanggal_post" type="date" class="form-control{{ $errors->has('tanggal_post') ? ' is-invalid' : '' }}" name="tanggal_post" value="{{ old('tanggal_post') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input id="priority" type="text" list="berita_terkini" class="form-control{{ $errors->has('title_post') ? ' is-invalid' : '' }}" name="priority">
